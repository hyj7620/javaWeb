...
<div id="header">
	<div class="top-wrapper">
		<h1 id="logo">
			<a href="${ctxName}/index"><img src="${ctxName}/resource/images/logo.png" alt="뉴렉처" /></a>
		...
		<ul id="loginmenu" class="block_hlist">
			...
			<li><a href="../joinus/login">로그인</a></li>
			<li><a href="${ctName}/j_spring_security_logout"><security:authentication
						property="name" />로그아웃</a></li>
			<security:authentication property="authorities" var="athorities" />
